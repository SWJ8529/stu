...
namespace MyScreenPrint
{
    public partial class FloatForm : Form
    {
        ...
        private void FloatForm_Load(object sender, EventArgs e)
        {
            ...
            FloatLabel.Font = new Font(this.Font.FontFamily, 13);

            FloatLabel.Text = "金额:0";
            this.Controls.Add(FloatLabel);
            //FloatLabel.TextChanged += FloatLabel_TextChanged;
        }

        private void FloatLabel_TextChanged(object sender, System.EventArgs e)
        {
            this.Width =FloatLabel.Width+30;
        }
    }
}
